...
public class Mail extends javax.mail.Authenticator {
    ...
    public void addAttachment(String filename, DataSource source) throws Exception {
        BodyPart messageBodyPart = new MimeBodyPart();
        //DataSource source = new FileDataSource(filename);
        messageBodyPart.setHeader("Content-Type: application/pdf; name="+filename+".pdf", "base64");
